...
<table align="center">
<tr><th style="width: 30%"><h2>UID</h2></th><td><input type="text" name="ide" id="ide" placeholder="id number"></td> </TR>
</table>




<center><button class="submit" type="submit" value="SUBMIT"><h3>DOWNLOAD</h3></button></center>
